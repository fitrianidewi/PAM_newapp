...
import com.example.new_app.Adapter.RvAdapter
import com.example.new_app.R
import com.example.new_app.databinding.ActivityCurrentWeatherBinding
import com.example.new_app.databinding.BottomSheetLayoutBinding
import com.example.new_app.forecastModels.ForecastData
import com.example.new_app.utils.RetrofitInstance
...
class CurrentWeather : AppCompatActivity() {
    ...
    private fun openDialog() {
        ...
        sheetLayoutBinding.rvForecast.apply {
            ...
            layoutManager = GridLayoutManager(this@CurrentWeather, 1, RecyclerView.HORIZONTAL, false)
